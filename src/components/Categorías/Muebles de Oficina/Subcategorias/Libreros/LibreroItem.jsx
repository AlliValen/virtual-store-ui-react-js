...
// Define el componente LibreroItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const LibreroItem = ({ producto }) => {
...
// Exporta el componente LibreroItem para que pueda ser utilizado en otras partes de la aplicación.
export default LibreroItem;
