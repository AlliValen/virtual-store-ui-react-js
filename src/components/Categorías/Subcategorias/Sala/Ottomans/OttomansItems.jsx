...
// Define el componente OttomansItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const OttomansItem = ({ producto }) => {
...
// Exporta el componente OttomansItem para que pueda ser utilizado en otras partes de la aplicación.
export default OttomansItem;
