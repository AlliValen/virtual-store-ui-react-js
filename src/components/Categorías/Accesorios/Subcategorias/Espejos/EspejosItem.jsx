...
// Define el componente EspejosItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const EspejosItem = ({ producto }) => {
...
// Exporta el componente EspejosItem para que pueda ser utilizado en otras partes de la aplicación.
export default EspejosItem;
