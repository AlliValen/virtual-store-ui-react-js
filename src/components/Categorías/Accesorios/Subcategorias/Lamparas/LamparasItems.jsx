...
// Define el componente LamparasItems, que recibe como prop un objeto de producto con nombre, precio e imagen.
const LamparasItems = ({ producto }) => {
...
// Exporta el componente LamparasItems para que pueda ser utilizado en otras partes de la aplicación.
export default LamparasItems;
