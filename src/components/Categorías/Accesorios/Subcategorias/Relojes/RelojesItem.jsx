...
// Define el componente RelojesItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const RelojesItem = ({ producto }) => {
...
// Exporta el componente RelojesItem para que pueda ser utilizado en otras partes de la aplicación.
export default RelojesItem;
