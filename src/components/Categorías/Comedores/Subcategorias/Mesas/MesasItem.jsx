...
// Define el componente MesasItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const MesasItem = ({ producto }) => {
...
// Exporta el componente MesasItem para que pueda ser utilizado en otras partes de la aplicación.
