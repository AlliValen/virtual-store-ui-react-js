...
// Define el componente SillasItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const SillasItem = ({ producto }) => {
...
// Exporta el componente SillasItem para que pueda ser utilizado en otras partes de la aplicación.
export default SillasItem;