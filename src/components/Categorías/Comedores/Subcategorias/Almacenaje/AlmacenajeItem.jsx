...
// Define el componente AlmacenajeItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const AlmacenajeItem = ({ producto }) => {
...
// Exporta el componente AlmacenajeItem para que pueda ser utilizado en otras partes de la aplicación.
export default AlmacenajeItem;
