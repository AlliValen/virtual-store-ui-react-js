...
// Define el componente CamasItems, que recibe como prop un objeto de producto con nombre, precio e imagen.
const CamasItems = ({ producto }) => {
...
// Exporta el componente CamasItems para que pueda ser utilizado en otras partes de la aplicación.
export default CamasItems;
