...
// Define el componente AlmacenamientoItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const AlmacenamientoItem = ({ producto }) => {
...
// Exporta el componente AlmacenamientoItem para que pueda ser utilizado en otras partes de la apl
export default AlmacenamientoItem;