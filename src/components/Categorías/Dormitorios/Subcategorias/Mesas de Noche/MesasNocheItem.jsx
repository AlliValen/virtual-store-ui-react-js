...
// Define el componente MesasNocheItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const MesasNocheItem = ({ producto }) => {
...
// Exporta el componente MesasNocheItem para que pueda ser utilizado en otras partes de la aplicación.
export default MesasNocheItem;
