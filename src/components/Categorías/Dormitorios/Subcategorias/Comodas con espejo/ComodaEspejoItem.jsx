...
// Define el componente ComodasEspejoItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const ComodaEspejoItem = ({ producto }) => {
...
// Exporta el componente ComodaEspejoItem para que pueda ser utilizado en otras partes de la aplicación.
export default ComodaEspejoItem;
