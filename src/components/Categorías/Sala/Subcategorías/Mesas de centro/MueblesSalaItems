...
// Define el componente MueblesMesaItem, que recibe como prop un objeto de producto con nombre, precio e imagen.
const MueblesSalaItem = ({ producto }) => {
...
// Exporta el componente MueblesMesaItem para que pueda ser utilizado en otras partes de la aplicación.
export default MueblesSalaItem;
